"""
Punto de entrada del Robot de Conciliación Siigo–DIAN
...
from enviador_correo import enviar_correo
...
def main():
    ...
    try:
        resultado, ruta_dian_marcado, ruta_siigo_marcado = conciliar(
            ruta_dian=ruta_dian,
    ...
    try:
        ruta_excel = generar_reporte(resultado, ruta_output)
    except Exception as e:
    ...
    # 6. Resumen ejecutivo en Consola
    logger.info("=" * 65)
